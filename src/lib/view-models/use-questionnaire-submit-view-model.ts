...
//   }
  ...
  //       closedate: String(extract("review_deadline_date")),
  ...
  //       creator_message_to_raters: String(extract("additional_message_to_rater")) ?? "",
  //       is_latest: true,
...
export interface IInsertHumanReviewInput {
  ...
  HumanReviewThumbnail: {
    thumbnails: string[]; // JSON structure, define specifically if known
    titles: string[];
    tags: ITags[] | null;
    niche: INiche | null;
