            ...
            render={() => (
              <FormItem className="w-full max-w-6xl mx-auto">
                ...
                <FormControl>
                  <div
                    {...getRootProps()}
                    className="w-full mx-auto flex flex-col items-center justify-center gap-y-4 rounded-lg border border-yellow-500  p-8 shadow-sm shadow-foreground cursor-pointer
                      hover:border-purple-400 focus-within:border-purple-600 focus-within:ring-2 focus-within:ring-purple-500 focus:border-0 transition-colors"
                  >
                    {previews.length > 0 ? (
                      <div className="
      grid w-full gap-3
