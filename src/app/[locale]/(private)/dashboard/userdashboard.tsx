    ...
    createOptions: [
      {
        ...
        title: "Upload and get AI feedback",
        img_url: "/thumbnail1.png",
        description: "Upload 4 or more Thumbnails for AI Analysis",
        buttonText: "Upload and Analyse",
        icon: "image-stack",
      },
      {
        id: "inviate_human_review",
        title: "Ask people for feedback",
        img_url: "/thumbnail2.png",
        description: "Get real people to give you opinions",
        buttonText: "Get Human Feedback",
        icon: "single-image",
      },
      {
        id: "review_others_for_credit",
        title: "Feedback For Credit",
        img_url: "/thumbnail3.png",
        description: "Rate other creators work and get credits",
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {mockDashboard.createOptions.map((option) => (
            <Card
              key={option.id}
              className="hover:shadow-lg border-2 border-transparent hover:border-blue-500 transition-colors duration-300"
            >

              <CardHeader className="overflow-hidden rounded-md group">
                <Image
                  src={option.img_url}
                  alt={option.title}
                  width={500}
              ...
              <CardContent className="space-y-2">
                ...
                <Button
                  className="w-full mt-2 cursor-pointer bg-blue-500"
                  variant="default"
                >
                  {option.buttonText}
                </Button>
